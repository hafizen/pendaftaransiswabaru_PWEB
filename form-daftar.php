    ...
    <div class="card w-96 bg-neutral text-neutral-content">
        ...
        <h1>Pendaftaran Siswa Baru</h1>
            <div class="form-control">
                <form action="proses-pendaftaran.php" method="POST" class="space-y-4">
                    ...
                    <div class="flex justify-center">
                        <button class="btn btn-active btn-primary"><input type="submit" value="Daftar" name="daftar" /></button>
                    </div>
                </form>
            </div>
        </div>
